            ...
            <Card className="p-8">
              ...
              <div className="space-y-4 text-muted-foreground">
                ...
                <div className="bg-muted/30 p-4 rounded-lg">
                  ...
                  <ul className="list-disc list-inside space-y-2 text-sm">
                    <li><strong>Remote Online Notary (RON):</strong> $5 notary fee per signature (Pennsylvania statutory maximum) + $55 technology platform fee covering secure video infrastructure, identity verification systems, document storage (10 years as legally required), scheduling systems, and administrative overhead.</li>
