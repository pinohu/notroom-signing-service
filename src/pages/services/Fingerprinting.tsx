            ...
            <Card className="p-8 border-primary border-2">
              <div className="text-center mb-8">
                ...
                <div className="mt-4 bg-muted/30 p-4 rounded-lg max-w-md mx-auto">
                  <p className="text-sm">Example: 20 miles from Erie</p>
                  <div className="text-xs space-y-1 mt-2">
                    <div className="flex justify-between"><span>Fingerprinting service:</span><span className="font-semibold">$35</span></div>
                    <div className="flex justify-between"><span>Travel (40 miles round-trip):</span><span className="font-semibold">$60</span></div>
                    <div className="flex justify-between border-t pt-1 mt-1"><span className="font-bold">Total:</span><span className="font-bold">$95</span></div>
                  </div>
                </div>
              </div>
