...
const Corry = () => {
  ...
  return (
    <Layout>
      <SEO
        title="Corry PA Notary | Mobile, Online, Apostille, I-9, LLC Formation Services"
        description="Professional notary services in Corry, PA. Remote online notary, mobile notary, loan signing, apostille services, I-9 verification, LLC formation. Same-day available."
        keywords="Corry notary, notary Corry PA, mobile notary Corry, online notary Corry, loan signing Corry, apostille Corry, I-9 Corry, LLC Corry, notary near me Corry"
      ...
      <section className="py-20 bg-gradient-to-br from-primary to-accent text-primary-foreground">
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-4xl mx-auto">
            <div className="inline-flex items-center gap-2 bg-primary-foreground/10 px-4 py-2 rounded-full mb-6"><MapPin className="w-4 h-4" /><span>Corry, PA</span></div>
            <h1 className="text-5xl md:text-6xl font-bold mb-6">Corry Notary Services</h1>
            <p className="text-xl mb-8">Complete notary and business services for Corry</p>
