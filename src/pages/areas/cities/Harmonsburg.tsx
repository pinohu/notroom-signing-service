...
const Harmonsburg = () => {
  ...
  const services = [
    { icon: Video, title: "Remote Online Notary (RON)", price: "$45", description: "Online notarization available 24/7 for Harmonsburg residents from anywhere", link: "/services/remote-online-notary" },
    { icon: Car, title: "Mobile Notary", price: "$125+", description: "We travel to your home, office, or location in Harmonsburg", link: "/services/mobile-notary" },
