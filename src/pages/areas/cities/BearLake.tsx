...
const BearLake = () => {
  ...
  const services = [
    { icon: Video, title: "Remote Online Notary (RON)", price: "$45", description: "Online notarization 24/7 for Bear Lake residents", link: "/services/remote-online-notary" },
    { icon: Car, title: "Mobile Notary", price: "$125+", description: "We come to your home or office in Bear Lake", link: "/services/mobile-notary" },
