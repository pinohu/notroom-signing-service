      ...
      <section className="py-20 bg-gradient-to-br from-primary to-accent text-primary-foreground">
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-4xl mx-auto">
            <div className="inline-flex items-center gap-2 bg-primary-foreground/10 px-4 py-2 rounded-full mb-6"><MapPin className="w-4 h-4" /><span>Hermitage, PA</span></div>
            ...
            <Button size="lg" onClick={scrollToBooking} variant="secondary">Book Service</Button>
          </div>
        </div>
      </section>
