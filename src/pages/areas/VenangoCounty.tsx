...
const VenangoCounty = () => {
  ...
  const schema = {
    ...
    "name": "Notroom Notary Services - Venango County",
    "description": "Professional mobile and online notary services in Venango County, PA. Serving Oil City, Franklin, and all surrounding areas.",
    "areaServed": {
      "@type": "State",
      "name": "Pennsylvania",
      "containsPlace": {
  ...
  return (
    <Layout>
      <SEO
        title="Venango County Notary Services | Oil City, Franklin | Mobile & Online"
        description="Professional notary services throughout Venango County, PA. Mobile service in Oil City, Franklin, and all surrounding areas. Online notarization available statewide. Fast, reliable, licensed."
        keywords="Venango County notary, Oil City notary, Franklin notary, mobile notary Venango County, online notary Pennsylvania"
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center text-white">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">
              Venango County's Trusted<br />Notary Service
            </h1>
            
            <p className="text-xl md:text-2xl mb-8 text-white/90 leading-relaxed">
              Professional mobile and online notarization serving Oil City, Franklin, and all of Venango County
            </p>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            <Card className="p-8 hover:shadow-lg transition-shadow border-2">
              <div className="text-center">
                ...
                <p className="text-muted-foreground mb-6">We come to you anywhere in Venango County</p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-center text-muted-foreground mt-6">
              And all surrounding Venango County communities
            </p>
          </div>
        </div>
      </section>
